    ...
    while ITER < ITERMAX
        ...
        for I = 1:S % PARTICLE POSITION UPDATE
              ...
              R2 = rand(); % random number [0-1]
                       V{I} = W*V{I}+C1*R1*(PB{I}-X_C{I})/DT+C2*R2*(GB-X_C{I})/DT; % PARTICLE VELOCITY UPDATE % LボLamda
            if V{I}>VMAX_LMT
